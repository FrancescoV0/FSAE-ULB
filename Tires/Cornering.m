% Code to analyse the data available at:
% https://github.com/shiliu520/Formula-SAE-Tire-Test-Data.git
...
B1654run15_params.ForceY.P1.deg0 = global_params_avg(1,:);
B1654run15_params.ForceY.P1.deg2 = global_params_avg(2,:);
B1654run15_params.ForceY.P1.deg4 = global_params_avg(3,:);
B1654run15_params.ForceY.P2.deg0 = global_params_avg(4,:);
B1654run15_params.ForceY.P2.deg2 = global_params_avg(5,:);
B1654run15_params.ForceY.P2.deg4 = global_params_avg(6,:);
B1654run15_params.ForceY.P3.deg0 = global_params_avg(7,:);
B1654run15_params.ForceY.P3.deg2 = global_params_avg(8,:);
B1654run15_params.ForceY.P3.deg4 = global_params_avg(9,:);
